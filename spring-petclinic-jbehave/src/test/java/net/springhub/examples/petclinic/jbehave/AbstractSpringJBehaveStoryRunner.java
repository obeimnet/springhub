...
@ActiveProfiles("jpa")
public abstract class AbstractSpringJBehaveStoryRunner extends JUnitStory {
    ...
    public AbstractSpringJBehaveStoryRunner() {
    ...
    protected abstract StoryPathResolver storyPathResolver() ;
